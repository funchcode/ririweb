ORIGIN_JAR_PATH='/home/jenkins/ririweb-member/deploy/*.jar'
ORIGIN_JAR_NAME=$(basename ${ORIGIN_JAR_PATH})
TARGET_PATH='/home/jenkins/ririweb-member/application.jar'
JAR_BOX_PATH='/home/jenkins/ririweb-member/jar/'
